        ...
        <form method='get' id="searchForm">
            <div class="input-group">
                ...
                <div class="input-group-append">
                    <input type='button' id='btnsearch' class="btn btn-primary" value='Search' onclick='document.getElementById("searchForm").submit();'>
                </div>
            </div>
        </form>
      </div>
<div class="col-md-8">
  <div class="btn-group mb-4 float-end" role="group" aria-label="Basic example">
      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#update_password_model">Set Password & send</button>
      <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#send_mail_model">Send Common Mail</button>
  </div>
