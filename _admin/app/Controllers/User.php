...
class User extends BaseController
{
    public function index()
    {
      ...
      if (! session()->get('logged_in'))
      {
        ...
        $keyword = "";
        if(isset($searchData) && isset($searchData['keyword'])){
          $keyword = $searchData['keyword'];
        }

        $userList = $userModel->paginate(50)->orderBy('name', 'DESC');

        /*
        if($keyword == ''){
            $userList = $userModel->paginate(50);
        }
        else
        {
            ...
            ->orLike('name', $keyword)
            ->orLike('email_id', $keyword)
            ->orLike('mobile_no', $keyword)
            ->paginate(50);
        }
        */
    ...
    public function report()
    {
      ...
      if (! session()->get('logged_in'))
      {
        ...
        $data['page'] = view('pages/user/report', $data);
        return view('templates/default', $data);
    }
    ...
    public function search_result()
    {
      ...
      if (! session()->get('logged_in'))
      {
        ...
        //$data['page'] = view('pages/user/search_result', $data);
        return view('pages/user/search_result', $data);
    }
}
